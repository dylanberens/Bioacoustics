...
function App() {
  ...
  const handleFileSelect = (files: File[]) => {
    if (files.length > 0) {
      ...
      // Check file type
      const allowedSubtypes = ['wav', 'mp3', 'mpeg', 'flac', 'm4a', 'ogg', 'webm', 'aiff', 'aif', 'x-aiff', 'opus', 'wma', 'caf', 'x-caf'];
      if (file.type && !allowedSubtypes.some(sub => file.type.includes(sub))) {
        setError('Please select a valid audio file (WAV, MP3, FLAC, M4A, OGG, AIF, OPUS, WMA and more)');
        return;
      }
      ...
      >
        ...
        >
            ...
            >
              ...
              <FileUpload onChange={handleFileSelect} onError={(msg) => setError(msg)} />
